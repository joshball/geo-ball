...
//     'application/xml'
// }
export const cssProps = (props?: React.CSSProperties): React.CSSProperties =>
...
export interface IHttpHeaders<TParameterData> extends IBaseHttpParameters<TParameterData> {}

export class BaseHttpParameters<TParameterData = any>
    implements IBaseHttpParameters<TParameterData> {
    paramData: Optional<TParameterData>;
...
export class HttpHeaders<TParameterData = any> extends BaseHttpParameters<TParameterData>
    implements IHttpHeaders<TParameterData> {
    constructor(paramData?: Optional<TParameterData>) {
        super(paramData);
    }
}
...
> {
    ...
    headers: IHttpHeaders<THeadersData>;
}

export class ApiParameters<TUrlParameterData = any, TBodyParameterData = any, THeadersData = any>
