...
import { Card, css } from '@geo-ball/component-lib';
...
export class ApiUrlParametersView extends React.Component<
    IApiUrlParametersViewProps,
    IApiUrlParametersViewState
> {
    ...
    getQueryParams(obj: any) {
        const map = Object.keys(obj).map(
            k => encodeURIComponent(k) + '=' + encodeURIComponent((obj as any)[k]),
        );
        return {
            map,
            url: map.join('&'),
