export declare type OpenStreetMapTagObject = {
    [k in OpenStreetMapTag]?: string;
};
/**
 ...
 *
 */
export declare type OpenStreetMapTag = 'access' | 'alt_name' | 'barrier' | 'bicycle' | 'bridge' | 'button_operated' | 'change:lanes:backward' | 'change:lanes:forward' | 'change:lanes' | 'colour' | 'created_by' | 'crossing' | 'cycleway:left' | 'cycleway:right' | 'cycleway' | 'destination:ref' | 'destination:street' | 'destination' | 'direction' | 'fixme' | 'foot' | 'footway' | 'guidepost' | 'hgv' | 'highway' | 'history' | 'horse' | 'hov:lanes' | 'hov:minimum' | 'hov' | 'incline' | 'lanes:backward' | 'lanes:both_ways' | 'lanes:forward' | 'lanes' | 'layer' | 'lcn' | 'lit' | 'location' | 'maxspeed:backward' | 'maxspeed:forward' | 'maxspeed:hgv' | 'maxspeed:trailer' | 'maxspeed' | 'motor_vehicle' | 'name_1' | 'name' | 'noref' | 'oneway' | 'parking:lane: left' | 'parking:lane:both' | 'parking:lane:right' | 'psv' | 'public_transport' | 'railway' | 'ref' | 'service' | 'sidewalk' | 'source:maxspeed' | 'source' | 'status' | 'stop' | 'surface' | 'tiger:cfcc' | 'tiger:county' | 'tiger:name_base_1' | 'tiger:name_base' | 'tiger:name_direction_prefix' | 'tiger:name_direction_suffix' | 'tiger:name_type_1' | 'tiger:name_type' | 'tiger:reviewed' | 'tiger:separated' | 'tiger:source' | 'tiger:tlid' | 'tiger:upload_uuid' | 'tiger:zip_right' | 'traffic_calming' | 'traffic_signals:direction' | 'traffic_signals' | 'turn:lanes:backward' | 'turn:lanes:forward' | 'turn:lanes';
//# sourceMappingURL=OpenStreetMapTag.d.ts.map