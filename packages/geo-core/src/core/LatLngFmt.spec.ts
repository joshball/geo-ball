...
test('formatLatLng returns lat lng', t => {
    const p = new LatLng(40.7160335695977551, -111.8504939999999976);
    t.is(formatLatLng(p.lat, p.lng), '40.71603 Lat, -111.85049 Lng');
});

test('formatLatLng returns simple array strings', t => {
    const p = new LatLng(40.7160335695977551, -111.8504939999999976);
    t.is(formatLatLng(p.lat, p.lng, { labelFmt: '' }), '40.71603, -111.85049');
});

test('formatLatLng returns simple precision', t => {
    const p = new LatLng(40.7160335695977551, -111.8504939999999976);
    t.is(formatLatLng(p.lat, p.lng, { labelFmt: '', precision: 2 }), '40.72, -111.85');
});

test('formatLatLng handles quickFmt: array', t => {
    const p = new LatLng(40.7160335695977551, -111.8504939999999976);
    t.is(formatLatLng(p.lat, p.lng, { quickFmt: 'array' }), '40.71603, -111.85049');
});

test('formatLatLng handles quickFmt: array precision', t => {
    const p = new LatLng(40.7160335695977551, -111.8504939999999976);
    t.is(formatLatLng(p.lat, p.lng, { quickFmt: 'array', precision: 2 }), '40.72, -111.85');
});

test('formatLatLng handles quickFmt: short', t => {
    const p = new LatLng(40.7160335695977551, -111.8504939999999976);
    t.is(formatLatLng(p.lat, p.lng, { quickFmt: 'short' }), '40.71603 Lat, -111.85049 Lng');
});

test('formatLatLng handles quickFmt: shortlon', t => {
    const p = new LatLng(40.7160335695977551, -111.8504939999999976);
    t.is(formatLatLng(p.lat, p.lng, { quickFmt: 'shortLon' }), '40.71603 Lat, -111.85049 Lon');
});
