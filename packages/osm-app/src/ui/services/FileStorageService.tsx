...
export class FileStorageService {
    static async EnsureDirectoryStructure(dirToEnsure: string): Promise<void> {
        await ipc.callRender(
            backgroundWindow,
            CHANNELS.FS.ensureExists,
            dirToEnsure
        );
    }
    ...
    static async ReadDir(
        ...
        if (options && options.withFileTypes) {
            return ipc.callRender(
                backgroundWindow,
                CHANNELS.FS.readdir,
                params
            ) as Promise<Array<Dirent>>;
        }
    ...
    static async ReadDirWithFullPaths(
        ...
        if (options && options.withFileTypes) {
            return FileStorageService.ReadDir(directoryPath) as Promise<
                Array<Dirent>
            >;
        }
        if (options && options.encoding && isBufferType(options.encoding)) {
        ...
        return (
            (FileStorageService.ReadDir(directoryPath) as Promise<
                Array<string>
            >)
...
// app.getPath('exe')          C:\Users\joshua\Google Drive\_src\geo-ball\packages\osm-app\node_modules\electron\dist\electron.exe
// app.getPath('logs')         C:\Users\joshua\AppData\Roaming\Electron\logs
// app.getPath('module')       C:\Users\joshua\Google Drive\_src\geo-ball\packages\osm-app\node_modules\electron\dist\electron.exe
