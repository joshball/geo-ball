...
import {
    AppSettingsBoxComponent,
    AppSettingsBoxProps,
} from './AppSettingsBoxComponent';
...
export class AppSettingsComponent extends React.Component<
    AppSettingsProps,
    AppSettingsState
> {
    ...
    constructor(props: AppSettingsProps) {
        ...
        this.setRootPathToUsersHomeDir = this.setRootPathToUsersHomeDir.bind(
            this
        );
        this.setRootPathToAppUsersDir = this.setRootPathToAppUsersDir.bind(
            this
        );
        ...
        this.onFileInputDirectorySelected = this.onFileInputDirectorySelected.bind(
            this
        );
    }
    ...
    async onFileInputDirectorySelected(file: File): Promise<void> {
        console.log(
            'DataDirectorySettings.onFileInputDirectorySelected(file)',
            file
        );
    ...
    render() {
        ...
        const props: AppSettingsBoxProps = {
        ...
        return <AppSettingsBoxComponent {...props} />;
    }
}
