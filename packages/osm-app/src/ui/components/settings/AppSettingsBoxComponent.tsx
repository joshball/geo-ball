...
//     overflow: 'hidden',
// });
const settingsHeaderRowCss = {};

// const settingsHeaderRowCss = css({
//     alignItems: 'center',
//     maxWidth: '600px',
// });
const settingsSubHeaderRowCss = {};

// const settingsSubHeaderRowCss = css({
//     alignItems: 'center',
// });
const settingsStaticValueCss = {};
...
//     marginBottom: '20px',
// });
const buttonSpaceCss = {};

// const buttonSpaceCss = css({
//     marginLeft: '20px',
// });

export interface AppSettingsBoxProps {
...
export const AppSettingsBoxComponent: React.SFC<AppSettingsBoxProps> = (
    props: AppSettingsBoxProps
) => {
        ...
        <div {...dirSettingsBoxCss}>
            <div {...settingsHeaderRowCss}>
                ...
                <p className={'bp3-running-text'}>
                    When you download OpenStreetMap data from the servers, that
                    data is placed in a managed directory. We parse that data
                    into other meta data formats and use it for the graph
                    algorithms. The data is stored with precise filenames to
                    keep allow us to move it through its different stages.
                </p>
                <p className={'bp3-running-text'}>
                    By default, we also store the data in a directory named{' '}
                    <code>.geo-ball</code>. You can adjust that here as well,
                    but note that any path you select will append that value to
                    that directory.
                </p>
            </div>
            <div {...settingsSubHeaderRowCss}>
                ...
                <p className={'bp3-running-text'}>
                    By default, we also store the data in a directory named{' '}
                    <code>.geo-ball</code>. We don't recommend you change this,
                    but if you need to, here you go.
                </p>
            ...
            <div {...settingButtonsRowCss}>
                <ButtonGroup>
                    ...
                    <Button
                        intent={Intent.SUCCESS}
                        icon="box"
                        onClick={props.setFolderAppUserData}
                    >
