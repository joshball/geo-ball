...
import { IOsmFetchManager } from '../../services/fetch/OsmFetchManager';
import { OsmFetchDir, IOsmFetchDir } from '../../services/fetch/OsmFetchDir';
...
> {
    ...
    constructor(props: MapDataFilesComponentProps) {
        ...
        const ucsdAppDataPath = '';
        const osmFetchDirPath = '';
        this.state = { allOsmFetchDirs: [], osmFetchDirPath };
        console.log(
            'MapDataFilesComponent.refresh(): osmFetchDirPath',
            osmFetchDirPath
        );
        console.log(
            'MapDataFilesComponent.refresh(): ucsdAppDataPath',
            ucsdAppDataPath
        );
    ...
    render() {
        ...
        console.log(
            'RENDER: MapDataFilesComponent.osmFetchDirPath',
            osmFetchDirPath
        );
        console.log(
            'RENDER: MapDataFilesComponent.allOsmFetchDirs',
            allOsmFetchDirs
        );
        console.log(
            'RENDER: MapDataFilesComponent.selectedFetchDir',
            selectedFetchDir
        );
        ...
        return (
            ...
            <div>
                ...
                <div>
                    <H5>
                        Data Fetch Directory:&nbsp;&nbsp;&nbsp;
                        <code>{osmFetchDirPath}</code>
                    </H5>
                </div>
                <div>
