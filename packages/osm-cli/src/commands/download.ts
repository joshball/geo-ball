...
import { OpenStreetmapDownloader, OpenStreetmapFileMetaData, IFetchAndSaveResult, OpenStreetmapQuery, GeographicBoundsDescription, IOpenStreetmapFileMetaData, IGeographicBoundsDescription } from '@geo-ball/osm-data';
