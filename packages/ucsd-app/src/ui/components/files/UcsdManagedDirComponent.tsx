...
import { IValidateFolder, FolderSelectorComponent, FolderSelectorComponentProps } from './FolderSelectorComponent';
...
export class UcsdManagedDirComponent extends React.Component<UcsdManagedDirComponentProps, UcsdManagedDirComponentState> {
    ...
    constructor(props: UcsdManagedDirComponentProps) {
        ...
        console.log('props.stores.data.getManagedDirectory', props.stores!.data.getManagedDirectory)
        this.state = {
