...
export const getOtherSettingsForm = () => {
    return (
        <div {...queryColStyle}>
            {OWF(
                <FormGroup
                    labelFor="settings.exclude_place_ids"
                    label="Exclude PID's"
                    inline={true}
                >
            ...
            {OWF(
                <FormGroup labelFor="settings.viewbox" label="Viewbox" inline={true}>
                    <Field name="settings.viewbox" component={FormikInputGroup} />
                </FormGroup>,
            )}
            {OWF(
                <FormGroup labelFor="settings.email" label="Email" inline={true}>
                    <Field name="settings.email" component={FormikInputGroup} />
                </FormGroup>,
            )}
            {OWF(
                <FormGroup
                    labelFor="settings.accept_language"
            ...
            {OWF(
                <FormGroup labelFor="settings.json_callback" label="JSON cb" inline={true}>
                    <Field name="settings.json_callback" component={FormikInputGroup} />
                </FormGroup>,
            )}
            {OWF(
                <FormGroup labelFor="settings.limit" label="Limit" inline={true}>
                    <Field
                        type="number"
                        name="settings.limit"
                        min={0}
            ...
            {OWF(
                <FormGroup labelFor="settings.countrycodes" label="Countries" inline={true}>
