...
export class OsmDownalodApiPanel extends React.Component<OsmDownalodApiPanelProps, OsmDownalodApiPanelState> {
    ...
    getDivBoxItems() {
        ...
        const divBoxItems = nums.map((n, i) => <div key={i} {...divBoxItemStyle}>{n}</div>);
        return (
            <div {...divBoxContainerStyle}>
                {divBoxItems}
            </div>
        );
    }
