...
export interface RadioButtonGroupContainerProps extends IButtonGroupNoChangeProps {
...
// }
export class RadioButtonGroupContainer extends React.Component<RadioButtonGroupContainerProps, RadioButtonGroupContainerState> {

    state: RadioButtonGroupContainerState;

    constructor(props: RadioButtonGroupContainerProps) {
        super(props);
