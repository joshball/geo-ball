...
import { styles, colors, fannypackTheme } from "../config/theme"
import { ThemeProvider } from "@geo-ball/component-lib"
    ...
    constructor(props: MemoryRouterProps) {
        ...
        mr.history.listen((location: any, action: any) => {
            ...
            console.log(
                ...
                JSON.stringify(mr.history, null, 2),
            )
        })
    }
}
            ...
            <DebugRouter {...ROOT}>
                <Provider stores={rootStore}>
                    <ThemeProvider>
                        <div>
                            <NavBarMenuComponent />
                            <Switch>{MAIN_ROUTE_COMPONENTS}</Switch>
                        </div>
                    </ThemeProvider>
                </Provider>
            </DebugRouter>
